  ...
  register_field_group(array (
    ...
    'fields' => array (
      ...
      array (
        ...
        'name' => 'registrations_email_subject',
        'type' => 'text',
        'default_value' => '',
        'placeholder' => '',
        'prepend' => '',
      ...
      array (
        ...
        'name' => 'registrations_email_message',
        'type' => 'textarea',
        'instructions' => ':name, :event_name, :event_link, :payment_option_name and :amount will be replaced with the actual values from the registration. (Note that amount will have to be prefixed with the currency)',
        'default_value' => '',
        'placeholder' => '',
        'maxlength' => '',
        'rows' => '',
